...
public class JelliesSounds {
    public static final DeferredRegister<SoundEvent> SOUNDS = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, Jellies.MOD_ID);

    public static final TFCSounds.EntitySound JELLIE = new TFCSounds.EntitySound(() -> SoundEvents.SLIME_SQUISH_SMALL, () -> SoundEvents.SLIME_DEATH_SMALL, () -> SoundEvents.SLIME_HURT_SMALL,
            () -> SoundEvents.EMPTY,
    ...
    private static RegistryObject<SoundEvent> createSound(String name) {
        return SOUNDS.register(name, () -> SoundEvent.createVariableRangeEvent(
                ResourceLocation.fromNamespaceAndPath(Jellies.MOD_ID, name)));
    }
