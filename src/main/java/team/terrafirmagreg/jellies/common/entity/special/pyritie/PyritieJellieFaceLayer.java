...
public class PyritieJellieFaceLayer extends RenderLayer<PyritieJellie, PyritieJellieModel<PyritieJellie>> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            Jellies.id("pyritie_jellie_face"), "main");

    private final JellieBaseModel model;

    public PyritieJellieFaceLayer(RenderLayerParent<PyritieJellie, PyritieJellieModel<PyritieJellie>> renderer, EntityModelSet ctx) {
        super(renderer);
