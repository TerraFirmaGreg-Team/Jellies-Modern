...
public class RedeixJellieOuterLayer extends RenderLayer<RedeixJellie, RedeixJellieModel<RedeixJellie>> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            Jellies.id("redeix_jellie_outer"), "main");

    private final RedeixJellieModel model;

    public RedeixJellieOuterLayer(RenderLayerParent<RedeixJellie, RedeixJellieModel<RedeixJellie>> renderer, EntityModelSet modelSet) {
        super(renderer);
        this.model = new RedeixJellieModel(modelSet.bakeLayer(LAYER_LOCATION));
    }
